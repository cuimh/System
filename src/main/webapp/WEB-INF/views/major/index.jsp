...
<body class="gray-bg">
		...
		<div class="ibox float-e-margins">
			<div class="ibox-content">
				<div class="page-header">
					<h3 class="text-center" id="flowTitle">专业查询</h3>
				</div>
				<form class="form-horizontal query-form" id="fee-form" method="post">
					<div class="form-group form-group-sm">
	                    ...
	                    <input type="text" name="majorname" placeholder="请输入专业名称" class="form-control required" minlength="2" maxlength="40">
	                  </div>
						</div>
					</div>
					<div class="form-group form-group-sm">
						<div class="input-tip">
							<label class="col-md-1 control-label">专业编号：</label>
							<div class="col-md-2 col-xs-2 col-sm-2">
	                    <input type="text" name="majorno" placeholder="请输入专业编号" class="form-control required" minlength="2" maxlength="40">
	                  </div>
						</div>
					</div>
					<div class="form-group">
						<div
							...
							<button type="button" class="btn btn-primary pull-right"
								...
								<span class="glyphicon btn-primary"></span><span>&nbsp;新增专业&nbsp;</span>
							</button>
						</div>
			 ...
			 <input type="hidden" name="id" id="id" />
				<div class="ibox-content">
					<table id="table_fee" data-toggle="table"
						...
						<thead>
							<tr>
								<th data-field="majorno">专业编号</th>
								<th data-field="majorname">专业名称</th>
                ...
                <div class="modal-dialog modal-lg" style = "width:1200px;">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="feeBoxPanel">新增专业</h4>
	...
	<form id="addFeeForm" class="form-horizontal" method="post">
		...
		<div class="modal-body">
			<div class="form-group form-group-sm">
				<div class="input-tip">
					<label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label"><span class="text-danger">*&nbsp;</span>专业编号：</label>
					<div class="col-xs-3  col-sm-3 col-md-3 col-lg-3">
						<input type="text" name="majorno" placeholder="请输入专业编号"
				...
				<div class="form-group form-group-sm">
				<div class="input-tip">
					<label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label"><span class="text-danger">*&nbsp;</span>专业名称：</label>
					<div class="col-xs-3  col-sm-3 col-md-3 col-lg-3">
...
<script src="<%=root %>/common/URL.js"></script>
        ...
        <script src="<%=root %>/common/js/major/index.js"></script>