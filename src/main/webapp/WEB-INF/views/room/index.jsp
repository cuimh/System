...
<body class="gray-bg">
		...
		<div class="ibox float-e-margins">
			<div class="ibox-content">
				<div class="page-header">
					<h3 class="text-center" id="flowTitle">教室查询</h3>
				</div>
				<form class="form-horizontal query-form" id="fee-form" method="post">
					<div class="form-group form-group-sm">
	                    ...
	                    <input type="text" name="classNo" placeholder="请输入教室编号" class="form-control required" minlength="2" maxlength="40">
	                  </div>
						</div>
					</div>
					<div class="form-group">
						<div
							...
							<button type="button" class="btn btn-primary pull-right"
								...
								<span class="glyphicon btn-primary"></span><span>&nbsp;新增教室&nbsp;</span>
							</button>
						</div>
					...
					<table id="table_fee" data-toggle="table"
						...
						<thead>
							<tr>
								...
								<th data-field="classNo">教室编号</th>
								<th data-field="calsspeople">人数</th>
								<th data-field="classaddress">地址</th>
                ...
                <div class="modal-dialog modal-lg" style = "width:1200px;">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="feeBoxPanel">新增教室</h4>
	...
	<form id="addFeeForm" class="form-horizontal" method="post">
		...
		<div class="modal-body">
			<div class="form-group form-group-sm">
				<div class="input-tip">
					<label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label"><span class="text-danger">*&nbsp;</span>教室编号：</label>
					<div class="col-xs-3  col-sm-3 col-md-3 col-lg-3">
						<input type="text" name="classNo" placeholder="请输入教室编号"
				...
				<div class="form-group form-group-sm">
				<div class="input-tip">
					<label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label"><span class="text-danger">*&nbsp;</span>人数：</label>
					<div class="col-xs-3  col-sm-3 col-md-3 col-lg-3">
						<input type="text" name="calsspeople" placeholder="请输入人数"
							class="form-control required">
					</div>
				</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class="input-tip">
					<label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label">地址：</label>
					<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
					<div class="input-group">
                                <textarea name="classaddress" cols="40" rows="10" class="form-control" maxlength="50"></textarea>
					</div>
					</div>
				</div>
...
<script src="<%=root %>/common/URL.js"></script>
        ...
        <script src="<%=root %>/common/js/room/index.js"></script>