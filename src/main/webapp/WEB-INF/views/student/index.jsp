...
<body class="gray-bg">
		...
		<div class="ibox float-e-margins">
			<div class="ibox-content">
				<div class="page-header">
					<h3 class="text-center" id="flowTitle">学生查询</h3>
				</div>
				<form class="form-horizontal query-form" id="fee-form" method="post">
					<div class="form-group form-group-sm">
	                    ...
	                    <input type="text" name="stuNo" placeholder="请输入学号" class="form-control required" minlength="2" maxlength="40">
	                  </div>
						</div>
					</div>
					<div class="form-group form-group-sm">
						<div class="input-tip">
							...
							<div class="col-md-2 col-xs-2 col-sm-2">
	                    <input type="text" name="stuname" placeholder="请输入姓名" class="form-control required" minlength="2" maxlength="40">
	                  </div>
						</div>
					</div>
					<div class="form-group">
						<div
							...
							<button type="button" class="btn btn-primary pull-right"
								...
								<span class="glyphicon btn-primary"></span><span>&nbsp;新增学生信息&nbsp;</span>
							</button>
						</div>
                ...
                <div class="modal-dialog modal-lg" style = "width:1200px;">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="feeBoxPanel">新增学生信息</h4>
	...
	<form id="addFeeForm" class="form-horizontal" method="post">
		...
		<div class="modal-body">
			<div class="form-group form-group-sm">
				<div class="input-tip">
					<label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label"><span class="text-danger">*&nbsp;</span>学号号：</label>
				...
				<div class="form-group form-group-sm">
				<div class="input-tip">
					<label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label"><span class="text-danger">*&nbsp;</span>姓名：</label>
					<div class="col-xs-3  col-sm-3 col-md-3 col-lg-3">
			...
			<div class="form-group form-group-sm">
				<div class="input-tip">
                            <label class="control-label col-md-2 col-xs-2 col-sm-2"><span class="text-danger">*&nbsp;</span>专业：</label>
                            <div class="col-md-2 col-xs-2 xol-sm-2">
                                <input type="hidden" name="majorname" value=""/>
                                <select name="zid" class="form-control role-list required" id="majorId">
                                    <option value="">请选择</option>
                                </select>
                            </div>
                        </div>
			...
			<div class="form-group form-group-sm">
				<div class="input-tip">
                            <label class="control-label col-md-2 col-xs-2 col-sm-2"><span class="text-danger">*&nbsp;</span>班级：</label>
                            <div class="col-md-2 col-xs-2 xol-sm-2">
                                <input type="hidden" name="stuclass" value=""/>
                                <select name="stuclass" class="form-control role-list required" id="classId">
                                    <option value="">请选择</option>
...
<script src="<%=root %>/common/URL.js"></script>
        ...
        <script src="<%=root %>/common/js/student/index.js"></script>