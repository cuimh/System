...
<body class="gray-bg">
		...
		<div class="ibox float-e-margins">
			<div class="ibox-content">
				<div class="page-header">
					<h3 class="text-center" id="flowTitle">院校查询</h3>
				</div>
				<form class="form-horizontal query-form" id="fee-form" method="post">
					<div class="form-group form-group-sm">
						<div class="input-tip">
							<label class="col-md-1 control-label">院系名称：</label>
							<div class="col-md-2 col-xs-2 col-sm-2">
	                    <input type="text" name="departname" placeholder="请输入院系名称" class="form-control required" minlength="2" maxlength="40">
	                  </div>
						</div>
					</div>
					...
					<div class="form-group">
						<div
							...
							<button type="button" class="btn btn-primary pull-right"
								...
								<span class="glyphicon btn-primary"></span><span>&nbsp;新增院系&nbsp;</span>
							</button>
						</div>
			...
			<P></P>
			<div class="ibox float-e-margins">
			 <input type="hidden" name="departid" id="id" />
				<div class="ibox-content">
					<table id="table_fee" data-toggle="table"
						...
						<thead>
							<tr>
								...
								<th data-field="departinfo">简介</th>
                ...
                <div class="modal-dialog modal-lg" style = "width:1200px;">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="feeBoxPanel">新增院系</h4>
	...
	<form id="addFeeForm" class="form-horizontal" method="post">
		...
		<div class="modal-body">
			<div class="form-group form-group-sm">
				<div class="input-tip">
					<label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label"><span class="text-danger">*&nbsp;</span>院系名：</label>
					<div class="col-xs-3  col-sm-3 col-md-3 col-lg-3">
						<input type="text" name="departname" placeholder="请输入院系名"
				...
				<div class="input-tip">
					...
					<div class="input-group">
                                <textarea name="departinfo" cols="40" rows="10" class="form-control" maxlength="50">暂无描述</textarea>
					</div>
					</div>
				</div>
			</div>
...
<script src="<%=root %>/common/URL.js"></script>
        ...
        <script src="<%=root %>/common/js/depart/index.js"></script>