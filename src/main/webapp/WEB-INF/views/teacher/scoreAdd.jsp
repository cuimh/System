...
<body class="gray-bg">
		...
		<div class="ibox float-e-margins">
			<div class="ibox-content">
				<div class="page-header">
					<h3 class="text-center" id="flowTitle">成绩信息录入</h3>
				</div>
				<form class="form-horizontal query-form" id="fee-form" method="post">
					...
					<div class="input-tip">
							<label class="col-md-3 control-label">分数录入状态：</label>
                ...
                <div class="modal-dialog modal-lg" style = "width:1200px;">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="feeBoxPanel">添加分数信息</h4>
	...
	<form id="addFeeForm" class="form-horizontal" method="post">
		...
		<div class="modal-body">
			<div class="form-group form-group-sm">
				<div class="input-tip">
					<label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label"><span class="text-danger">*&nbsp;</span>分数：</label>
				...
				<div class="form-group form-group-sm">
				<div class="input-tip">
					<label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label"><span class="text-danger">*&nbsp;</span>绩点：</label>
					<div class="col-xs-3  col-sm-3 col-md-3 col-lg-3">
						<input type="text" name="credit" placeholder="请输入绩点"
							class="form-control required">
					</div>
				</div>
...
<script src="<%=root %>/common/URL.js"></script>
        ...
        <script src="<%=root %>/common/js/teacher/scoreAdd.js"></script>