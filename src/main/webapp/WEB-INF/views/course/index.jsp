...
<body class="gray-bg">
		...
		<div class="ibox float-e-margins">
			<div class="ibox-content">
				<div class="page-header">
					<h3 class="text-center" id="flowTitle">课程信息查询</h3>
				</div>
					...
					<div class="form-group">
						<div
							...
							<button type="button" class="btn btn-primary pull-right"
								...
								<span class="glyphicon btn-primary"></span><span>&nbsp;新增课程信息&nbsp;</span>
							</button>
						</div>
                ...
                <div class="modal-dialog modal-lg" style = "width:1200px;">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="feeBoxPanel">新增课程信息</h4>
	...
	<form id="addFeeForm" class="form-horizontal" method="post">
		...
		<div class="modal-body">
			<div class="form-group form-group-sm">
				<div class="input-tip">
					<label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label"><span class="text-danger">*&nbsp;</span>课程编号：</label>
					<div class="col-xs-3  col-sm-3 col-md-3 col-lg-3">
						<input type="text" name="classno" placeholder="请输入课程编号"
				...
				<div class="form-group form-group-sm">
				<div class="input-tip">
					<label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label"><span class="text-danger">*&nbsp;</span>课程名称：</label>
					<div class="col-xs-3  col-sm-3 col-md-3 col-lg-3">
			...
			<div class="form-group form-group-sm">
				<div class="input-tip">
                            <label class="control-label col-md-2 col-xs-2 col-sm-2"><span class="text-danger">*&nbsp;</span>教师：</label>
                            <div class="col-md-2 col-xs-2 xol-sm-2">
                                <input type="hidden" name="tername" value=""/>
                                <select name="teacherno" class="form-control role-list required" id="teaId">
                                    <option value="">请选择</option>
                                </select>
                            </div>
                        </div>
			...
			<div class="form-group form-group-sm">
				<div class="input-tip">
                            <label class="control-label col-md-2 col-xs-2 col-sm-2"><span class="text-danger">*&nbsp;</span>教室：</label>
                            <div class="col-md-2 col-xs-2 xol-sm-2">
                                <input type="hidden" name="classNo" value=""/>
                                <select name="courseaddress" class="form-control role-list required" id="roomId">
                                    <option value="">请选择</option>
                                </select>
                            </div>
                        </div>
			...
			<div class="form-group form-group-sm">
				<div class="input-tip">
					<label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label"><span class="text-danger">*&nbsp;</span>学分：</label>
					<div class="col-xs-3  col-sm-3 col-md-3 col-lg-3">
						<input type="text" name="coursegrade" placeholder="请输入学分"
							class="form-control required">
					</div>
				</div>
				...
				<div class="form-group form-group-sm">
				<div class="input-tip">
					<label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label"><span class="text-danger">*&nbsp;</span>上课时间：</label>
					<div class="col-xs-3  col-sm-3 col-md-3 col-lg-3">
						<input type="text" name="coursetime" placeholder="请输入上课时间"
							class="form-control required">
					</div>
				</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class="input-tip">
					...
					<div class="input-group">
                                <textarea name="courseabout" cols="40" rows="10" class="form-control" maxlength="50">暂无描述</textarea>
					</div>
					</div>
				</div>
			</div>
...
<script src="<%=root %>/common/URL.js"></script>
        ...
        <script src="<%=root %>/common/js/course/index.js"></script>